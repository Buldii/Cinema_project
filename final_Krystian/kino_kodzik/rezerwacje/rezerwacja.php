...
<body>
    ...
    <main class="reservation">
        ...
        <div class="legenda">
            <div>
                <span class="marker blueviolet"></span>
                <span class="description">Wolne</span>
            </div>
            <div>
                <span class="marker brown"></span>
                <span class="description">Zajęte</span>
            </div>
            <div>
                <span class="marker aqua"></span>
                <span class="description">Twoje miejsca</span>
            </div>
        </div>
    </main>
